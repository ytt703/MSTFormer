...
if __name__ == '__main__':
    ...
    parser.add_argument('--patch_sizes',type=int,nargs='+',default=[16],help='MSTFormer patch_size [48,16,4]')
    # parser.add_argument('--individual', type=int, default=0, help='individual head; True 1 False 0') #使用前一个individual
    #itransformer
    ...
    parser.add_argument('--sequence_num', type=int, default=3, help='the number of multi-scale sequences')
